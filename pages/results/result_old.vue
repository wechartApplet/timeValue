        ...
        <view class="result" v-if="showResults_man">
            <view class="divider-container">
                <view class="divider">
                    ...
                    <text class="divider_text">受教育的时间</text>
                    <view class="divider_line"></view>
                </view>
            </view>
            ...
            <view class="result-item">
                ...
                <text class="result-value">， 时间已经来到 {{ new Date().getFullYear() }} 年</text>
                <text class="result-value">， 应该攒够 {{ moneyCurrentSaved }} 元了吧</text>
            </view>

            <view class="result-item">
                <text class="result-label">假定最新的退休年龄为65</text>
                <text class="result-value">，那么退休前你应该还能存 {{ moneyBeforeRetirement }} 元</text>
                <text class="result-value">， 时间已经来到 {{ BeforeRetirementToDate }}</text>
            </view>
            ...
            <view class="result-item">
                ...
                <text class="result-value">， 时间已经来到 {{ fiveMillionToDate }}</text>
                <text class="result-value">， 那时你的年龄约为 {{ ageAtFiveMillion }} 岁</text>
            </view>

            <view class="result-item">
                <text class="result-label">你赚够三个亿所需要的时间约为：</text>
                <text class="result-value">{{ timeForThreeHundredMillion }} </text>
                <text class="result-value">， 时间已经来到 {{ threeHundredMillionToDate }}</text>
                <text class="result-value">， 那时你的年龄约为 {{ ageAtThreeHundredMillion }} 岁</text>
            </view>
...
export default {
    setup(props, context) {
        ...
        const fiveMillionToDate = ref(0);
        const threeHundredMillionToDate = ref(0);

        const ageAtFiveMillion = ref(0);
        const ageAtThreeHundredMillion = ref(0);
        ...
        onMounted(() => {
            ...
            if (query.data) {
                ...
                moneyCurrentSaved.value = new Intl.NumberFormat('en-US').format(calculateCurrentSavings(
                    birthDate, 25, monthlySalary));
                moneyBeforeRetirement.value = new Intl.NumberFormat('en-US').format(
                ...
                // 赋值
                fiveMillionToDate.value = addYearsToDate(birthDate, 25, fiveMillion_yd);
                threeHundredMillionToDate.value = addYearsToDate(birthDate, 25, threeHundredMill_yd);
                // 赋值
                ageAtFiveMillion.value = caculateAgeByActiveNum(25, fiveMillion_yd);
                ageAtThreeHundredMillion.value = caculateAgeByActiveNum(25, threeHundredMill_yd);
